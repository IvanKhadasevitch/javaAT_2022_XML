...
public class JournalSAXBuilderTest {
    /**
    ...
    static public void fillJournalFieldsBySAXParser() {
        try {
            ...
            journal = saxBuilder.buildJournal(XML_FILE_NAME, XSD_FILE_NAME);
    ...
    @Test
    @DisplayName("Check if after xml data file SAX parsing created the instance of Journal")
    public void testJournalIsInstanceOfJournal() {
        assertThat(journal)
                .as("Journal doesn't created after SAX parsing xml")
                .isInstanceOf(Journal.class);
    }
    @Test
    @DisplayName("Journal after SAX parsing has Title")
    ...
    @Test
    @DisplayName("Journal after SAX parsing has Contacts")
    ...
    @Test
    @DisplayName("Journal after SAX parsing has two articles")
    ...
    @Test
    @DisplayName("Journal after SAX parsing has Articles with filed fields")
