...
public class JournalDOMBuilderTest {
    /**
    ...
    @BeforeAll
    static public void fillJournalFieldsByDOMParser() {
        try {
            JournalDOMBuilder domBuilder = new JournalDOMBuilder();
            journal = domBuilder.buildJournal(XML_FILE_NAME, XSD_FILE_NAME);
    ...
    @Test
    @DisplayName("Check if after xml data file DOM parsing created the instance of Journal")
    public void testJournalIsInstanceOfJournal() {
        assertThat(journal)
                .as("Journal doesn't created after DOM parsing xml")
                .isInstanceOf(Journal.class);
    }
    @Test
    @DisplayName("Journal after DOM parsing has Title")
    ...
    @Test
    @DisplayName("Journal after DOM parsing has Contacts")
    ...
    @Test
    @DisplayName("Journal after DOM parsing has two articles")
    ...
    @Test
    @DisplayName("Journal after DOM parsing has Articles with filed fields")
